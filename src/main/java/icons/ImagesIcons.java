...
public class ImagesIcons
{
	...
	public static final Image ThumbnailBlank = ImagesIconGroup.ThumbnailBlank();
	public static final Image ThumbnailDirectory = ImagesIconGroup.ThumbnailDirectory();
